...
const ProductInfo = (props) => {
    ...
    const { title, rating, totalRating, price, description, inStock } = props
    ...
    const handleOnClick = () => {
        ...
        // thu thap data, them truong id, disptach addToOrder + user's token
        const obj = {
            color: type,
            size: sizeType,
            quantity
    ...
    return (
        <div className="product-info-container">
            ...
            <div className="button my-4 flex gap-6">
                <div className="quantity-btn flex h-11">
                    ...
                    <div className="">
                        <input
                            className="max-w-[80px] text-lg border-[2px] border-[#ccc] h-full outline-none text-center"
                            name="quantity"
                            value={quantity}
                            min="1"
                            max="100"
