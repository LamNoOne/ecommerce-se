                ...
                <div className="grid grid-cols-3 gap-6 mt-6">
                    <div className="flex flex-col items-center justify-center gap-6 p-4 border bg-[#fef5f0]">
                        ...
                        <div className="button">
                            <button onClick={() => handleOnClickOffer()} className="flex items-center justify-center w-[174px] h-[47px] bg-white rounded-lg">
                                Go Detail
                            </button>
                        </div>
                    </div>
                    <div className="flex flex-col items-center justify-center gap-6 p-4 border bg-[#edf1fd]">
                        ...
                        <div className="button">
                            <button onClick={() => handleOnClickOrder()} className="flex items-center justify-center w-[174px] h-[47px] bg-white rounded-lg">
                    ...
                    <div className="flex flex-col items-center justify-center gap-6 p-4 border bg-[#f1f8fe]">
                        ...
                        <div className="button">
                            <button onClick={() => handleOnClickRank()} className="flex items-center justify-center w-[174px] h-[47px] bg-white rounded-lg">
                                <span className="text-base">Go Detail</span>
                            </button>
                        </div>
                    </div>
